...
from mmass.mspy import mod_basics, obj_peak
...
class TestPeakCore:
    """Tests for Peak initialization, reset, and mass calculation."""
...
class TestPeakSetters:
    """Tests for Peak setter methods."""
...
class TestPeakEdgeCases:
    """Tests for Peak edge cases and boundary conditions."""
...
class TestPeakIntegration:
    """Integration tests for Peak objects."""

    def test_attributes_dict_storage(self):
        """Test that attributes are stored and retrieved correctly."""
        p = obj_peak.Peak(mz=500.0, attr1='value1', attr2=42, attr3=3.14, nested={'key': 'value'})
...
class TestPeakPropertyBased:
    """Property-based tests for Peak objects."""

    @given(mz=st.floats(min_value=1.0, max_value=10000.0, allow_nan=False, allow_infinity=False), ai=st.floats(min_value=0.0, max_value=100000.0, allow_nan=False, allow_infinity=False), base=st.floats(min_value=0.0, max_value=100000.0, allow_nan=False, allow_infinity=False))
    ...
    @given(mz=st.floats(min_value=1.0, max_value=10000.0, allow_nan=False, allow_infinity=False), charge=st.integers(min_value=1, max_value=10))
    ...
    @given(mz=st.floats(min_value=1.0, max_value=10000.0, allow_nan=False, allow_infinity=False), fwhm=st.floats(min_value=0.01, max_value=100.0, allow_nan=False, allow_infinity=False))
    ...
    @given(mz_old=st.floats(min_value=1.0, max_value=10000.0, allow_nan=False, allow_infinity=False), mz_new=st.floats(min_value=1.0, max_value=10000.0, allow_nan=False, allow_infinity=False), fwhm=st.floats(min_value=0.01, max_value=100.0, allow_nan=False, allow_infinity=False))
