...
from mmass.gui import dlg_mascot_editor, libs, mwx
...
def dialog_fixture(mocker, wx_app):
    ...
    mocker.spy(dlg_mascot_editor.DlgMascotEditor, "updateItemsList")

    # Instantiate dialog
    dialog = dlg_mascot_editor.DlgMascotEditor(parent)
