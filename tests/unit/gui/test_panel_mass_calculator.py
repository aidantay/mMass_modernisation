...
def test_onToolSelected_by_event(calculator_panel, mocker):
    ...
    mock_event = mocker.MagicMock()
    mock_event.GetId.return_value = ids.ID_massCalculatorIonSeries
...
def test_onToolSelected_ids(calculator_panel, mocker):
    ...
    for tool_id, tool_name in [
        (ids.ID_massCalculatorSummary, "summary"),
        (ids.ID_massCalculatorIonSeries, "ionseries"),
        (ids.ID_massCalculatorPattern, "pattern"),
    ]:
        mock_event = mocker.MagicMock()
