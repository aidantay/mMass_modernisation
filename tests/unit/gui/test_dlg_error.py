...
from mmass.gui import dlg_error
...
def test_dlg_error_initialization(wx_app):
    ...
    dlg = dlg_error.DlgError(None, "Test Exception")
    try:
...
def test_dlg_error_ui_elements(wx_app):
    ...
    dlg = dlg_error.DlgError(None, "Test UI")
    try:
        # Check text control
...
def test_dlg_error_on_quit(wx_app, mocker):
    ...
    dlg = dlg_error.DlgError(None, "Test Quit")
    try:
...
def test_dlg_error_layout(wx_app):
    ...
    dlg = dlg_error.DlgError(None, "Test Layout")
    try:
