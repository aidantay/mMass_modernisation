...
def test_dlgCompoundsEditor_onImport_replace_logic(dlg_editor_instance, compounds_lib, mocker):
    ...
    mocker.patch.object(dlg_editor_instance, 'readLibraryXML', return_value=imported_items)
