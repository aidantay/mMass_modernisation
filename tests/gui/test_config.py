...
def backup_config():
    ...
    config_vars = [
        'internal', 'main', 'recent', 'colours', 'export', 'spectrum', 
        'match', 'processing', 'calibration', 'sequence', 'massCalculator', 
        'massToFormula', 'massDefectPlot', 'compoundsSearch', 'peakDifferences', 
        'comparePeaklists', 'spectrumGenerator', 'envelopeFit', 'mascot', 
        'profound', 'prospector', 'links'
    ]
