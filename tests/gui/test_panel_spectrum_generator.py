...
def test_getParams_happy(panel, mocker):
    ...
    mocker.patch.object(panel.peakShape_choice, 'GetStringSelection', return_value='Symmetrical')
...
def test_getParams_asymmetrical(panel, mocker):
    mocker.patch.object(panel.peakShape_choice, 'GetStringSelection', return_value='Asymmetrical')
    from gui import config
    assert panel.getParams() is True
