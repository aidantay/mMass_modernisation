...
def test_update_differences_grid(panel):
    ...
    # Check colors
    assert panel.differencesGrid.GetCellBackgroundColour(1, 0) == wx.Colour(100, 255, 100) # value
    assert panel.differencesGrid.GetCellBackgroundColour(2, 0) == wx.Colour(0, 200, 255)  # amino
    assert panel.differencesGrid.GetCellBackgroundColour(2, 1) == wx.Colour(100, 255, 255) # dipep
