import pytest
import wx
from gui.panel_document_info import panelDocumentInfo, dlgPresetsName
from gui.ids import *
...
def test_onPresetsSelected(panel, mocker):
    ...
    mocker.patch('gui.panel_document_info.libs.presets', {'operator': {'Preset 1': preset_data}})
...
def test_onPresetsSave(panel, mocker):
    ...
    mock_presets = mocker.patch('gui.panel_document_info.libs.presets', {'operator': {}})
...
def test_onPresetsSave_cancel(panel, mocker):
    mocker.patch('gui.panel_document_info.dlgPresetsName').return_value.ShowModal.return_value = wx.ID_CANCEL
