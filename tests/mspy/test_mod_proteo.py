...
class TestFragmentlosses:
    ...
    def test_fragmentlosses_filter_out(self, reset_stopper):
        ...
        result = mod_proteo.fragmentlosses(
            frags, losses=["H2O"], filterOut={"H2O": ["b"]}
        )
    ...
    def test_fragmentlosses_filter_in(self, reset_stopper):
        ...
        result = mod_proteo.fragmentlosses(
            frags, losses=["H2O"], filterIn={"H2O": ["b"]}
        )
    ...
    def test_fragmentlosses_filter_in_wrong_series(self, reset_stopper):
        ...
        result = mod_proteo.fragmentlosses(
            frags, losses=["H2O"], filterIn={"H2O": ["y"]}
        )
    ...
    def test_fragmentlosses_two_losses_on_fragment(self, reset_stopper):
        ...
        result = mod_proteo.fragmentlosses(
            frags, losses=["H2O", "H3PO4", "NH3"], limit=2
        )
    ...
    def test_fragmentlosses_complex_combinations(self, reset_stopper):
        ...
        result = mod_proteo.fragmentlosses(
            frags, losses=["H2O", "NH3"], defined=False, limit=2
        )
...
class TestFragmentgains:
    ...
    def test_fragmentgains_filter_out(self, reset_stopper):
        ...
        result = mod_proteo.fragmentgains(
            frags, gains=["H2O"], filterOut={"H2O": ["b"]}
        )
    ...
    def test_fragmentgains_invalid_composition(self, reset_stopper):
        ...
        result = mod_proteo.fragmentgains(
            frags, gains=["H2O"], filterIn={"H2O": ["im"]}
        )
    ...
    def test_fragmentgains_multiple_gains(self, reset_stopper):
        ...
        result1 = mod_proteo.fragmentgains(
            frags, gains=["H2O"], filterIn={"H2O": ["b"]}
        )
        result2 = mod_proteo.fragmentgains(
            result1, gains=["CO"], filterIn={"CO": ["b", "break"]}
        )
...
class TestDigestAdditionalCoverage:
    """Additional tests for digest() to cover remaining branches."""

    def test_digest_allowmods_true_with_modification_on_cleavage_site(
        self, reset_stopper
    ):
...
class TestFragmentAdditionalCoverage:
...
class TestFragmentserieAdditionalCoverage:
...
class TestFragmentlossesAdditionalCoverage:
    ...
    def test_fragmentlosses_filter_in_and_filter_out_together(self, reset_stopper):
        ...
        # Apply both filters
        result = mod_proteo.fragmentlosses(
            frags, losses=["H2O"], filterIn={"H2O": ["b"]}, filterOut={}
        )

        assert isinstance(result, list)


class TestFragmentgainsAdditionalCoverage:
    ...
    def test_fragmentgains_cyclic_parent_detection(self, reset_stopper):
        ...
        result = mod_proteo.fragmentgains(
            frags, gains=["CO"], filterIn={"CO": ["b", "break"]}
        )
    ...
    def test_fragmentgains_multiple_gains_on_fragment_list(self, reset_stopper):
        ...
        result2 = mod_proteo.fragmentgains(
            result1, gains=["NH3"], filterIn={"NH3": ["b"]}
        )
...
class TestBranchCoverageTargeted:
    ...
    def test_fragmentlosses_combination_with_limit_greater_than_losses(
        self, reset_stopper
    ):
    ...
    def test_fragmentgains_break_in_history_check(self, reset_stopper):
        ...
        result = mod_proteo.fragmentgains(
            frags, gains=["CO"], filterIn={"CO": ["break"]}
        )
    ...
    def test_fragmentserie_c_terminal_removes_first_on_cterm_filter(
        self, reset_stopper
    ):
    ...
    def test_digest_two_consecutive_modifications_different_positions(
        self, reset_stopper
    ):
...
class TestBranchCoverageMinimal:
    ...
    def test_fragmentserie_c_terminal_ntermfilter_cond(self, reset_stopper):
        ...
        """
        s = seq("MAKRF")  # 5 AAs
        frags = mod_proteo.fragmentserie(
            s, "x"
        )  # x: C-term, nTermFilter=True, cTermFilter=False
