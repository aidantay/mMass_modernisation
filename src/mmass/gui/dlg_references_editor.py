...
class dlgReferencesEditor(wx.Dialog):
    ...
    def makeGroupEditor(self):
        ...
        groupImport_butt = wx.Button(self, wx.ID_ANY, "Import")
        groupImport_butt.Bind(wx.EVT_BUTTON, self.onImport)

        groupNew_butt = wx.Button(self, wx.ID_ANY, "New")
        groupNew_butt.Bind(wx.EVT_BUTTON, self.onAddGroup)

        groupRename_butt = wx.Button(self, wx.ID_ANY, "Rename")
        groupRename_butt.Bind(wx.EVT_BUTTON, self.onRenameGroup)

        groupDelete_butt = wx.Button(self, wx.ID_ANY, "Delete")
    ...
    def makeItemEditor(self):
        ...
        # make elements
        itemDescription_label = wx.StaticText(self, wx.ID_ANY, "Description:")
        self.itemDescription_value = wx.TextCtrl(self, wx.ID_ANY, "", size=(280, -1))

        itemMass_label = wx.StaticText(self, wx.ID_ANY, "m/z:")
        self.itemMass_value = wx.TextCtrl(self, wx.ID_ANY, "", size=(280, -1))
...
class dlgGroupName(wx.Dialog):
    ...
    def makeGUI(self):
        ...
        self.name_value = wx.TextCtrl(
            self, wx.ID_ANY, self.name, size=(300, -1), style=wx.TE_PROCESS_ENTER
        )
        ...
        mainSizer.Add(buttons, 0, wx.ALIGN_CENTER | wx.ALL, mwx.PANEL_SPACE_MAIN)
