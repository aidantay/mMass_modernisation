...
class dlgPreferences(wx.Dialog):
    ...
    def makeUpdatesPage(self):
        ...
        self.updatesEnabled_check = wx.CheckBox(
            panel, wx.ID_ANY, "Automatically check for updates"
        )
        ...
        updateNow_butt = wx.Button(panel, wx.ID_ANY, "Check Now", size=(100, -1))
        updateNow_butt.Bind(wx.EVT_BUTTON, self.onUpdateNow)

        # pack elements
        mainSizer = wx.BoxSizer(wx.VERTICAL)
        mainSizer.Add(label_label, 0, wx.ALIGN_CENTER | wx.ALL, 10)
        mainSizer.Add(self.updatesEnabled_check, 0, wx.ALIGN_CENTER | wx.ALL, 10)
        mainSizer.Add(updateNow_butt, 0, wx.ALIGN_CENTER | wx.ALL, 10)
    ...
    def makeCompassPanel(self):
        ...
        compassMode_label = wx.StaticText(panel, wx.ID_ANY, "Extracted data:")
        self.compassMode_choice = wx.Choice(
            panel, wx.ID_ANY, choices=["Profile", "Line"], size=(120, mwx.CHOICE_HEIGHT)
        )
        ...
        compassFormat_label = wx.StaticText(panel, wx.ID_ANY, "Data format:")
