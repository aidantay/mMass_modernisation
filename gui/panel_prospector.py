...
class panelProspector(wx.MiniFrame):
    ...
    def getParams(self):
        ...
        try:
            ...
            if config.prospector["common"]["searchType"] == "msfit":
                ...
                config.prospector["msfit"]["miscleavages"] = (
            ...
            if config.prospector["common"]["searchType"] == "mstag":
                ...
                config.prospector["mstag"]["miscleavages"] = (
    ...
    def makeSearchHTML(self):
        ...
        buff += (
            '      <input type="text" name="database" value="%s" />\n'
        ...
        buff += (
            '      <input type="text" name="enzyme" value="%s" />\n'
            % (config.prospector[form]["enzyme"])
        )
        buff += (
            '      <input type="text" name="missed_cleavages" value="%s" />\n'
        ...
        buff += (
            '      <input type="text" name="instrument_name" value="%s" />\n'
        ...
        if config.prospector["common"]["searchType"] == "msfit":
            ...
            buff += (
                '      <input type="text" name="mowse_pfactor" value="%s" />\n'
                % (config.prospector["msfit"]["pfactor"])
            )
            buff += (
                '      <input type="text" name="min_matches" value="%s" />\n'
                % (config.prospector["msfit"]["minMatches"])
            )
            buff += (
