...
class dlgNotation(wx.Dialog):
    ...
    def __init__(self, parent: Any, notation: Any, button: str = "Add") -> None:
        ...
        # set dlg title
        fmt = "Notation for m/z: %0." + repr(config.main["mzDigits"]) + "f"
        title = fmt % (self.notation.mz)
        self.SetTitle(title)
    ...
    def makeGUI(self) -> wx.BoxSizer:
        ...
        mainSizer.Add(labelBox, 0, wx.EXPAND | wx.ALL, mwx.PANEL_SPACE_MAIN)
        mainSizer.Add(
            formulaBox,
            0,
