...
class panelSequence(wx.MiniFrame):
    ...
    def __init__(self, parent, tool="editor"):
        wx.MiniFrame.__init__(
            ...
            "Sequence",
            size=(500, 300),
            style=wx.DEFAULT_FRAME_STYLE & ~(wx.RESIZE_BOX | wx.MAXIMIZE_BOX),
        )
    ...
    def updateDigestList(self):
        ...
        for index, item in enumerate(self.currentDigest):
            # filter data
            if (self._digestFilter == 1 and item[5] == None) or (
                self._digestFilter == -1 and item[5] != None
            ):
                continue
    ...
    def updateFragmentsList(self):
        ...
        for index, item in enumerate(self.currentFragments):
            # filter data
            if (self._fragmentsFilter == 1 and item[5] == None) or (
                self._fragmentsFilter == -1 and item[5] != None
            ):
                continue
