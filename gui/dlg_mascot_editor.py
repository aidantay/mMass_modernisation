...
class dlgMascotEditor(wx.Dialog):
    ...
    def __init__(self, parent: wx.Window) -> None:
        super().__init__(
            parent,
            id=wx.ID_ANY,
            title="Mascot Servers Library",
            style=wx.DEFAULT_DIALOG_STYLE | wx.RESIZE_BORDER,
        )

        self.itemsMap: list[tuple[str, str, str]] = []
    ...
    def makeGUI(self) -> wx.BoxSizer:
        ...
        sizer.Add(editor, 0, wx.EXPAND | wx.ALL, mwx.PANEL_SPACE_MAIN)
    ...
    def makeItemEditor(self) -> wx.StaticBoxSizer:
        ...
        self.itemName_value = wx.TextCtrl(self, id=wx.ID_ANY, value="", size=(200, -1))

        itemHost_label = wx.StaticText(self, id=wx.ID_ANY, label="Host name:")
        self.itemHost_value = wx.TextCtrl(self, id=wx.ID_ANY, value="", size=(200, -1))

        itemPath_label = wx.StaticText(self, id=wx.ID_ANY, label="Mascot path:")
        self.itemPath_value = wx.TextCtrl(self, id=wx.ID_ANY, value="/", size=(200, -1))

        itemSearch_label = wx.StaticText(self, id=wx.ID_ANY, label="Search:")
        self.itemSearch_value = wx.TextCtrl(
            self, id=wx.ID_ANY, value="cgi/nph-mascot.exe", size=(170, -1)
        )

        itemResults_label = wx.StaticText(self, id=wx.ID_ANY, label="Results:")
        self.itemResults_value = wx.TextCtrl(
            self, id=wx.ID_ANY, value="cgi/master_results.pl", size=(170, -1)
        )

        itemExport_label = wx.StaticText(self, id=wx.ID_ANY, label="Export:")
        self.itemExport_value = wx.TextCtrl(
            self, id=wx.ID_ANY, value="cgi/export_dat_2.pl", size=(170, -1)
        )

        itemParams_label = wx.StaticText(self, id=wx.ID_ANY, label="Params:")
        self.itemParams_value = wx.TextCtrl(
            self, id=wx.ID_ANY, value="cgi/get_params.pl", size=(170, -1)
        )

        # buttons
        add_butt = wx.Button(self, id=wx.ID_ANY, label="Add", size=(80, -1))
        add_butt.Bind(wx.EVT_BUTTON, self.onAddItem)

        delete_butt = wx.Button(self, id=wx.ID_ANY, label="Delete", size=(80, -1))
