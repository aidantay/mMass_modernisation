...
class dlgModificationsEditor(wx.Dialog):
    ...
    def __init__(self, parent: Any) -> None:
        super().__init__(
            parent,
            id=wx.ID_ANY,
            title="Modifications Library",
            style=wx.DEFAULT_DIALOG_STYLE | wx.RESIZE_BORDER,
        )

        self.itemsMap: list[tuple[str, str, str, float, float, str, str, str]] = []
    ...
    def makeItemEditor(self) -> wx.StaticBoxSizer:
        ...
        self.itemName_value = wx.TextCtrl(self, wx.ID_ANY, "", size=(250, -1))

        itemDescription_label = wx.StaticText(self, wx.ID_ANY, "Description:")
        self.itemDescription_value = wx.TextCtrl(self, wx.ID_ANY, "", size=(250, -1))

        itemAminoSpecifity_label = wx.StaticText(self, wx.ID_ANY, "Amino specifity:")
        self.itemAminoSpecifity_value = wx.TextCtrl(self, wx.ID_ANY, "", size=(250, -1))

        itemTermSpecifity_label = wx.StaticText(self, wx.ID_ANY, "Terminal specifity:")
    ...
    def onFormulaEdited(self, evt: wx.CommandEvent) -> None:
