...
class panelProfound(wx.MiniFrame):
    ...
    def makeSearchHTML(self):
        ...
        buff += (
            '  <form action="%s" id="mainSearch" method="post">\n'
        ...
        buff += (
            '      <input type="text" name="MCLV" value="%s" />\n'
            % (config.profound["miscleavages"])
        )
        buff += (
            '      <input type="text" name="MINM" value="%s" />\n'
            % (config.profound["proteinMassLow"])
        )
        buff += (
            '      <input type="text" name="MAXM" value="%s" />\n'
            % (config.profound["proteinMassHigh"])
        )
        buff += (
            '      <input type="text" name="MINP" value="%s" />\n'
            % (config.profound["proteinPILow"])
        )
        buff += (
            '      <input type="text" name="MAXP" value="%s" />\n'
            % (config.profound["proteinPIHigh"])
        )
        buff += (
            '      <input type="text" name="ERRA" value="%s" />\n'
            % (config.profound["peptideTol"])
        )
        buff += (
            '      <input type="text" name="ERRM" value="%s" />\n'
            % (config.profound["peptideTol"])
        )
        buff += (
            '      <input type="text" name="ERRT" value="%s" />\n'
            % (config.profound["peptideTolUnits"])
        )
        buff += (
            '      <input type="text" name="CHRG" value="%s" />\n'
            % (config.profound["charge"])
        )
        buff += (
            '      <input type="text" name="EXPT" value="%s" />\n'
            % (config.profound["expectation"])
        )
        buff += (
            '      <input type="text" name="NRET" value="%s" />\n'
            % (config.profound["candidates"])
        )
        buff += (
            '      <input type="text" name="CLST" value="%s" />\n'
            % (self.currentParams["ENZ"][config.profound["enzyme"]]["CLST"])
        )
        buff += (
            '      <input type="text" name="CNST" value="%s" />\n'
            % (self.currentParams["ENZ"][config.profound["enzyme"]]["CNST"])
        )
        buff += (
            '      <input type="text" name="CLMD" value="%s" />\n'
        ...
        for mod in config.profound["fixedMods"]:
            buff += (
                '      <input type="text" name="CMOD" value="%s" />\n'
                % (self.currentParams["CMOD"][mod])
            )
        for mod in config.profound["variableMods"]:
            buff += (
                '      <input type="text" name="PMOD" value="%s" />\n'
