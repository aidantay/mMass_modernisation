...
if not os.path.exists(confdir):
    raise OSError("Configuration folder cannot be found!")
...
def saveConfig(path=os.path.join(confdir, "config.xml")):
    ...
    buff += (
        '    <param name="appHeight" value="%d" type="int" />\n' % (main["appHeight"])
    )
    ...
    buff += (
        '    <param name="documentsWidth" value="%d" type="int" />\n'
        % (main["documentsWidth"])
    )
    buff += (
        '    <param name="documentsHeight" value="%d" type="int" />\n'
        % (main["documentsHeight"])
    )
    buff += (
        '    <param name="peaklistWidth" value="%d" type="int" />\n'
        % (main["peaklistWidth"])
    )
    buff += (
        '    <param name="peaklistHeight" value="%d" type="int" />\n'
        % (main["peaklistHeight"])
    )
    ...
    buff += (
        '    <param name="intDigits" value="%d" type="int" />\n' % (main["intDigits"])
    )
    buff += (
        '    <param name="ppmDigits" value="%d" type="int" />\n' % (main["ppmDigits"])
    )
    buff += (
        '    <param name="chargeDigits" value="%d" type="int" />\n'
        % (main["chargeDigits"])
    )
    ...
    buff += (
        '    <param name="errorUnits" value="%s" type="str" />\n' % (main["errorUnits"])
    )
    buff += (
        '    <param name="printQuality" value="%d" type="int" />\n'
        % (main["printQuality"])
    )
    ...
    buff += (
        '    <param name="serverPort" value="%d" type="int" />\n' % (main["serverPort"])
    )
    buff += '    <param name="updatesEnabled" value="%d" type="int" />\n' % (
        bool(main["updatesEnabled"])
    )
    buff += (
        '    <param name="updatesChecked" value="%s" type="str" />\n'
        % (main["updatesChecked"])
    )
    buff += (
        '    <param name="updatesCurrent" value="%s" type="str" />\n'
        % (main["updatesCurrent"])
    )
    buff += (
        '    <param name="updatesAvailable" value="%s" type="str" />\n'
        % (main["updatesAvailable"])
    )
    buff += (
        '    <param name="compassMode" value="%s" type="str" />\n'
        % (main["compassMode"])
    )
    buff += (
        '    <param name="compassFormat" value="%s" type="str" />\n'
        % (main["compassFormat"])
    )
    ...
    buff += "  <export>\n"
    buff += (
        '    <param name="imageWidth" value="%.1f" type="float" />\n'
        % (export["imageWidth"])
    )
    buff += (
        '    <param name="imageHeight" value="%.1f" type="float" />\n'
        % (export["imageHeight"])
    )
    buff += (
        '    <param name="imageUnits" value="%s" type="str" />\n'
        % (export["imageUnits"])
    )
    buff += (
        '    <param name="imageResolution" value="%d" type="int" />\n'
        % (export["imageResolution"])
    )
    buff += (
        '    <param name="imageFontsScale" value="%d" type="int" />\n'
        % (export["imageFontsScale"])
    )
    buff += (
        '    <param name="imageDrawingsScale" value="%d" type="int" />\n'
        % (export["imageDrawingsScale"])
    )
    buff += (
        '    <param name="imageFormat" value="%s" type="str" />\n'
        % (export["imageFormat"])
    )
    buff += '    <param name="peaklistColumns" value="%s" type="str" />\n' % (
    ...
    buff += (
        '    <param name="peaklistFormat" value="%s" type="str" />\n'
        % (export["peaklistFormat"])
    )
    buff += (
        '    <param name="peaklistSeparator" value="%s" type="str" />\n'
        % (export["peaklistSeparator"])
    )
    buff += (
        '    <param name="spectrumSeparator" value="%s" type="str" />\n'
    ...
    buff += (
        '    <param name="posBarSize" value="%d" type="int" />\n'
        % (spectrum["posBarSize"])
    )
    buff += (
        '    <param name="gelHeight" value="%d" type="int" />\n'
        % (spectrum["gelHeight"])
    )
    ...
    buff += (
        '    <param name="labelAngle" value="%d" type="int" />\n'
        % (spectrum["labelAngle"])
    )
    ...
    buff += (
        '    <param name="labelFontSize" value="%d" type="int" />\n'
        % (spectrum["labelFontSize"])
    )
    buff += (
        '    <param name="axisFontSize" value="%d" type="int" />\n'
    ...
    buff += (
        '    <param name="notationMaxLength" value="%d" type="int" />\n'
    ...
    buff += "  <match>\n"
    buff += (
        '    <param name="tolerance" value="%f" type="float" />\n'
        % (match["tolerance"])
    )
    ...
    buff += (
        '      <param name="offset" value="%f" type="float" />\n'
        % (processing["baseline"]["offset"])
    )
    buff += "    </baseline>\n"
    buff += "    <smoothing>\n"
    buff += (
        '      <param name="method" value="%s" type="str" />\n'
        % (processing["smoothing"]["method"])
    )
    buff += (
        '      <param name="windowSize" value="%f" type="float" />\n'
    ...
    buff += "    <peakpicking>\n"
    buff += (
        '      <param name="snThreshold" value="%f" type="float" />\n'
        % (processing["peakpicking"]["snThreshold"])
    )
    buff += (
        '      <param name="absIntThreshold" value="%f" type="float" />\n'
        % (processing["peakpicking"]["absIntThreshold"])
    )
    buff += (
        '      <param name="relIntThreshold" value="%f" type="float" />\n'
        % (processing["peakpicking"]["relIntThreshold"])
    )
    buff += (
        '      <param name="pickingHeight" value="%f" type="float" />\n'
    ...
    buff += (
        '      <param name="intTolerance" value="%f" type="float" />\n'
    ...
    buff += (
        '      <param name="labelEnvelope" value="%s" type="str" />\n'
        % (processing["deisotoping"]["labelEnvelope"])
    )
    buff += (
        '      <param name="envelopeIntensity" value="%s" type="str" />\n'
    ...
    buff += "  <calibration>\n"
    buff += (
        '    <param name="fitting" value="%s" type="str" />\n'
        % (calibration["fitting"])
    )
    buff += (
        '    <param name="tolerance" value="%f" type="float" />\n'
    ...
    buff += (
        '    <param name="units" value="%s" type="str" />\n' % (calibration["units"])
    )
    buff += (
        '    <param name="statCutOff" value="%d" type="int" />\n'
    ...
    buff += "    <editor>\n"
    buff += (
        '      <param name="gridSize" value="%d" type="int" />\n'
        % (sequence["editor"]["gridSize"])
    )
    buff += "    </editor>\n"
    buff += "    <digest>\n"
    buff += (
        '      <param name="maxMods" value="%d" type="int" />\n'
    ...
    buff += (
        '      <param name="miscl" value="%d" type="int" />\n'
    ...
    buff += (
        '      <param name="maxLosses" value="%d" type="int" />\n'
    ...
    buff += (
        '      <param name="charge" value="%d" type="int" />\n'
    ...
    buff += "  <massCalculator>\n"
    buff += (
        '    <param name="ionseriesAgent" value="%s" type="str" />\n'
        % (massCalculator["ionseriesAgent"])
    )
    buff += (
        '    <param name="ionseriesAgentCharge" value="%d" type="int" />\n'
        % (massCalculator["ionseriesAgentCharge"])
    )
    buff += (
        '    <param name="ionseriesPolarity" value="%d" type="int" />\n'
        % (massCalculator["ionseriesPolarity"])
    )
    buff += (
        '    <param name="patternFwhm" value="%f" type="float" />\n'
        % (massCalculator["patternFwhm"])
    )
    buff += (
        '    <param name="patternThreshold" value="%f" type="float" />\n'
    ...
    buff += "  <massToFormula>\n"
    buff += (
        '    <param name="countLimit" value="%d" type="int" />\n'
        % (massToFormula["countLimit"])
    )
    buff += (
        '    <param name="massLimit" value="%d" type="int" />\n'
    ...
    buff += (
        '    <param name="ionization" value="%s" type="str" />\n'
    ...
    buff += (
        '    <param name="formulaMin" value="%s" type="str" />\n'
        % (massToFormula["formulaMin"])
    )
    buff += (
        '    <param name="formulaMax" value="%s" type="str" />\n'
    ...
    buff += (
        '    <param name="HCMin" value="%f" type="float" />\n'
        % (massToFormula["HCMin"])
    )
    buff += (
        '    <param name="HCMax" value="%f" type="float" />\n'
        % (massToFormula["HCMax"])
    )
    buff += (
        '    <param name="NCMax" value="%f" type="float" />\n'
        % (massToFormula["NCMax"])
    )
    buff += (
        '    <param name="OCMax" value="%f" type="float" />\n'
        % (massToFormula["OCMax"])
    )
    buff += (
        '    <param name="PCMax" value="%f" type="float" />\n'
        % (massToFormula["PCMax"])
    )
    buff += (
        '    <param name="SCMax" value="%f" type="float" />\n'
        % (massToFormula["SCMax"])
    )
    buff += (
        '    <param name="RDBEMin" value="%f" type="float" />\n'
        % (massToFormula["RDBEMin"])
    )
    buff += (
        '    <param name="RDBEMax" value="%f" type="float" />\n'
    ...
    buff += "  <massDefectPlot>\n"
    buff += (
        '    <param name="yAxis" value="%s" type="str" />\n' % (massDefectPlot["yAxis"])
    )
    buff += (
        '    <param name="nominalMass" value="%s" type="str" />\n'
        % (massDefectPlot["nominalMass"])
    )
    buff += (
        '    <param name="kendrickFormula" value="%s" type="str" />\n'
        % (massDefectPlot["kendrickFormula"])
    )
    buff += (
        '    <param name="relIntCutoff" value="%f" type="float" />\n'
    ...
    buff += (
        '    <param name="ratioDirection" value="%d" type="int" />\n'
        % (comparePeaklists["ratioDirection"])
    )
    buff += (
        '    <param name="ratioThreshold" value="%f" type="float" />\n'
    ...
    buff += (
        '    <param name="fwhm" value="%f" type="float" />\n'
        % (spectrumGenerator["fwhm"])
    )
    buff += (
        '    <param name="points" value="%d" type="int" />\n'
        % (spectrumGenerator["points"])
    )
    buff += (
        '    <param name="noise" value="%f" type="float" />\n'
    ...
    buff += (
        '    <param name="relThreshold" value="%f" type="float" />\n'
    ...
    buff += (
        '      <param name="searchType" value="%s" type="str" />\n'
    ...
    buff += "    <pmf>\n"
    buff += (
        '      <param name="database" value="%s" type="unicode" />\n'
        % (mascot["pmf"]["database"])
    )
    buff += (
        '      <param name="taxonomy" value="%s" type="unicode" />\n'
        % (mascot["pmf"]["taxonomy"])
    )
    buff += (
        '      <param name="enzyme" value="%s" type="unicode" />\n'
        % (mascot["pmf"]["enzyme"])
    )
    buff += (
        '      <param name="miscleavages" value="%s" type="unicode" />\n'
    ...
    buff += (
        '      <param name="proteinMass" value="%s" type="unicode" />\n'
        % (mascot["pmf"]["proteinMass"])
    )
    buff += (
        '      <param name="peptideTol" value="%s" type="unicode" />\n'
        % (mascot["pmf"]["peptideTol"])
    )
    buff += (
        '      <param name="peptideTolUnits" value="%s" type="unicode" />\n'
        % (mascot["pmf"]["peptideTolUnits"])
    )
    buff += (
        '      <param name="massType" value="%s" type="unicode" />\n'
        % (mascot["pmf"]["massType"])
    )
    buff += (
        '      <param name="charge" value="%s" type="unicode" />\n'
        % (mascot["pmf"]["charge"])
    )
    ...
    buff += (
        '      <param name="report" value="%s" type="unicode" />\n'
        % (mascot["pmf"]["report"])
    )
    buff += "    </pmf>\n"
    buff += "    <sq>\n"
    ...
    buff += (
        '      <param name="msmsTol" value="%s" type="unicode" />\n'
        % (mascot["sq"]["msmsTol"])
    )
    buff += (
        '      <param name="msmsTolUnits" value="%s" type="unicode" />\n'
    ...
    buff += (
        '      <param name="instrument" value="%s" type="unicode" />\n'
        % (mascot["sq"]["instrument"])
    )
    buff += (
        '      <param name="quantitation" value="%s" type="unicode" />\n'
    ...
    buff += (
        '    <param name="proteinMassLow" value="%f" type="float" />\n'
        % (profound["proteinMassLow"])
    )
    buff += (
        '    <param name="proteinMassHigh" value="%f" type="float" />\n'
        % (profound["proteinMassHigh"])
    )
    buff += (
        '    <param name="proteinPILow" value="%d" type="int" />\n'
        % (profound["proteinPILow"])
    )
    buff += (
        '    <param name="proteinPIHigh" value="%d" type="int" />\n'
        % (profound["proteinPIHigh"])
    )
    buff += (
        '    <param name="peptideTol" value="%f" type="float" />\n'
        % (profound["peptideTol"])
    )
    buff += (
        '    <param name="peptideTolUnits" value="%s" type="unicode" />\n'
    ...
    buff += (
        '    <param name="ranking" value="%s" type="unicode" />\n'
        % (profound["ranking"])
    )
    buff += (
        '    <param name="expectation" value="%f" type="float" />\n'
        % (profound["expectation"])
    )
    buff += (
        '    <param name="candidates" value="%d" type="int" />\n'
        % (profound["candidates"])
    )
    buff += '    <param name="filterAnnotations" value="%d" type="int" />\n' % (
    ...
    buff += (
        '      <param name="proteinMassLow" value="%s" type="unicode" />\n'
        % (prospector["msfit"]["proteinMassLow"])
    )
    buff += (
        '      <param name="proteinMassHigh" value="%s" type="unicode" />\n'
        % (prospector["msfit"]["proteinMassHigh"])
    )
    buff += (
        '      <param name="proteinPILow" value="%s" type="unicode" />\n'
        % (prospector["msfit"]["proteinPILow"])
    )
    buff += (
        '      <param name="proteinPIHigh" value="%s" type="unicode" />\n'
    ...
    buff += (
        '      <param name="minMatches" value="%s" type="unicode" />\n'
        % (prospector["msfit"]["minMatches"])
    )
    buff += (
        '      <param name="maxMods" value="%s" type="unicode" />\n'
    ...
    buff += (
        '      <param name="pfactor" value="%s" type="unicode" />\n'
    ...
    buff += (
        '      <param name="peptideCharge" value="%s" type="unicode" />\n'
